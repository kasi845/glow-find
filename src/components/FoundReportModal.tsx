...
import { X, Handshake, Upload } from 'lucide-react';
...
export const FoundReportModal: React.FC<FoundReportModalProps> = ({ item, isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitClaim({
        ...
        claimerEmail: email,
        claimerPhone: phone,
        proofImage: imagePreview || 'https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=400',
        description: message,
      } as any);
      ...
      const errorMessage = err?.message || err?.toString() || (typeof err === 'string' ? err : "Failed to submit report");
      toast({
        title: "Error",
  ...
  return (
    ...
    >
      ...
      <div
        className="relative glass-card w-full max-w-md p-6 border border-pink-500/20 max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200"
      >
        <button
          onClick={onClose}
